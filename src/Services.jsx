...
const Services = () => {
    return (
        <div className="text-white lg:px-24 px-4" id='services'>
           ...
           {/* Sessão services */ }
           <div className=" lg:flex lg:justify-between items-start" id="">
            ...
            <div className="lg:w-2/3 my-8">
                <div className="flex flex-wrap">
                    ...
                    <div className="service-card">
                        <a href="/" className="text-2xl block relative">
                    ...
                    <div className="service-card">
                        <a href="/" className="text-2xl block relative">
                            ...
                            <div className=" absolute top-1/3 left-4 right-0">
                                <span className=" w-3 h-3 block rounded-full bg-orange mb-2"></span>
                                <h2 className="font-bold text-white text-2xl">React Js Project</h2>
                            </div>
                        </a>
                    </div>
                    <div className="service-card">
                        <a href="/" className="text-2xl block relative">
                            ...
                            <div className=" absolute top-1/3 left-4 right-0">
                                <span className=" w-3 h-3 block rounded-full bg-orange mb-2"></span>
                                <h2 className="font-bold text-white text-2xl">Digital Marketing</h2>
                            </div>
                        </a>
                    </div>
                    <div className=" lg:w-1/4 hidden lg:block"></div>
                    <div className="service-card">
                        <a href="/" className="rounded-2xl block relative">
                            ...
                            <div className=" absolute top-1/3 left-4 right-0">
                                <span className=" w-3 h-3 block rounded-full bg-orange mb-2"></span>
                                <h2 className="font-bold text-white text-2xl">Technology</h2>
                            </div>
                        </a>
                    </div>
                </div>
